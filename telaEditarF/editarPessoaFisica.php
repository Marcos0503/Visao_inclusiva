...
<head>
    ...
    <script src="editarPessoaFisica.php"></script>
...
<body>
    <header>
        <div>
            <img src="../editarPerfilFisica/img/logo1.png" alt="Logo Final">
        </div>
        <nav>
        ...
        <div class="boxText">
            <form action="">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="codigo" id="formacao" rows="3"></textarea>
                </div>
                <div class="form-group">
                    <label for="experiencia" class="txt">Experiência Profissional:</label>
                    <textarea class="form-control" name="codigo" id="experiencia" rows="3"></textarea>
                </div>
            </form>
        </div>
