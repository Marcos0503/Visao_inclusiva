...
include 'D:\xampp\htdocs\www\VI_Vagas\VI_Vagas\back\funcaoCadastrar.php';
...
<form action="adicaoDeVagas.php" method="POST">
      <div class="mb-3">
        ...
        <input class="titulo" name="titulo" placeholder="Titulo da vaga">
        <input class="titulo" name="empresa" placeholder="Nome da empresa">
        <input class="info" name="localizacao" placeholder="Local">
        <input class="info" name="salario" placeholder="Salário">
        <input class="mb-3" name="periodo" class="info" list="periodo" placeholder="Periodo">
        <datalist id="periodo">
          <input></input>
          <option value=" Tempo Integral">
          <option value=" Meio Período">
        </datalist>
        <input class="mb-3" name="tipo_contrato" class="info" list="tipo" placeholder="Tipo">
        <datalist id="tipo">
        <input></input>
      ...
      <div  class="mb-3">
        ...
        <textarea name="atividades"></textarea>

        </div>
        <div  class="mb-3">
          <h1 class="titulo">benefícios</h1>
          <textarea name="beneficios"></textarea>
              <input type="submit" name="submit" href="#" class="bnt-exibir" placeholder= "Exibir Mais">
            </div>
          </div>
</form>
