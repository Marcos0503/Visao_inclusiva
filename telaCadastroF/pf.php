    ...
    <div class="col-md-8 order-md-1">
      <form class="needs-validation" novalidate name="Cadastro" action="Cadastrar.php" method="POST"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control custom-input" id="nome_Completo" name="nome_Completo"
        ...
        <div class="row rgdata">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control custom-input" .cel-sp-mask id="telefone" name="telefone"
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="date" class="form-control custom-input" id="date_nasc" name="date_nasc"
        ...
        <div class="mb-3">
          <label for="CID"></label>
          <input type="text" class="form-control custom-input" .cel-sp-mask id="CID" name="CID" placeholder="CID"
            required>
          <div class="invalid-feedback" style="width: 100%;">
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control custom-input" id="email" name="email" placeholder="fulano@exemplo.com"
            required>
          <div class="invalid-feedback">
        ...
        <div class="mb-3">
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control custom-input" id="cidade" name="cidade" placeholder="Cidade"
                required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control custom-input" id="bairro" name="bairro" placeholder="Bairro"
                required>
              <div class="invalid-feedback">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control custom-input" id="sobre" name="sobre"
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="salvar-info">
            Eu li e concordo com os <a href="../politicaPrivacidade/Politica_Priv.php" target="_blank">termos de
              Privacidade</a>.
          </label>
        </div>
        <hr class="mb-4">
