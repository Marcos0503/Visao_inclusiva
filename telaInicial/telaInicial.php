...
<head>
  ...
  <style>
    ...
    body {
      ...
      background-size: 10%;
      /* Ou 100% ou qualquer outro valor que pareça adequado */
      background-repeat: no-repeat;
      height: 100vh;
      /* Adiciona esta linha para definir a altura da tela inteira */
      margin: 0;
    }
    ...
    .primeira-tela {
      ...
      text-align: center;
      height: 100%;
      /* Faz com que a segunda tela ocupe 100% da altura do corpo */
      box-sizing: border-box;
      /* Inclui padding e borda na altura total */
    }
    ...
    .album {
      background-image: url('../img/backgrond2.png');
      /* Alterado para transparente para remover o fundo branco */
    }
  </style>
</head>
  ...
  <div class="container-fluid primeira-tela" style="background-image: url('../img/backgrond.jpeg');">
    ...
    <div class="row">
      <div class="col-md-6 apresentacao align-items-center">
        <h2>Facilite as chances de mudar sua vida profissional aqui! Diversas empresas inclusivas esperam a sua
          inscrição!</h2>
        <button type="button" onclick="window.location.href='../telaCadastroF/pf.php'"
          class="btn btn-outline-primary">Cadastre-se</button>
      </div>
      <div class="col-md-6 al apresentacao2 align-items-center">
        ...
        <button type="button" onclick="window.location.href='../telaCadastroJ/pj.php'"
          class="btn btn-outline-primary">Cadastre sua empresa</button>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/35UVzcC3qA0?si=l4Hll3IijBgn7NFd" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
                  ao conteúdo adicional.</p>
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/SaP1k83fIz8?si=_A1_BGc9jsRH4_Oy" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/pf8KoWwW21I?autoplay=0" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/tAQCmXvmvAk?si=u6vu2U4VMlMRH0XX" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/ZbUWI-O7BQA?si=ykZj89TtYsFIVPSA" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/TSYK-iDxqW8?si=mBgkOWsM068npO1w" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/wi_0_J4Vp04?si=HlvBPxbzqhN1s-TF" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <iframe class="card-img-top" width="100%" height="225"
                src="https://www.youtube.com/embed/UNUEG31hIDg?si=jpc9Ia9UDaiUVaBc" frameborder="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
              <div class="card-body">
                <p class="card-text">Este é um card maior e que suporta texto abaixo, como uma introdução mais natural
